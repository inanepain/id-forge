...
class EncoderFactory {
    ...
    public static function createBase32(): Base32Encoder {
        return new Base32Encoder(new EncoderConfig(Characters::base32()));
    }
    ...
    public static function createBase58(): Base58Encoder {
        return new Base58Encoder(new EncoderConfig(Characters::base58()));
    }
    ...
    public static function createBase64(): Base64Encoder {
        return new Base64Encoder(new EncoderConfig(Characters::base64()));
    }
}
